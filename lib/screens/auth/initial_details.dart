...
class _InitialDetailsState extends State<InitialDetails> {
  ...
  Future<void> addData(String bride, String groom, String hashtag, String venue,
    ...
    try {
      ...
      await LocalData.saveNameAndId(bride, groom, user.uid);
      await LocalData.saveIsCouple(true);
      await model.saveUpdatePrompt('Bride: $bride, Groom: $groom, Wedding hashtag: $hashtag, Venue: $venue, Date: $date, and some more details are $more');
